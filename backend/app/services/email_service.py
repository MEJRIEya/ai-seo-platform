...
async def send_password_reset_email(to: str, reset_token: str):
    ...
    <div style="font-family: Arial, sans-serif; max-width: 480px; margin: auto;">
        ...
        <p>Vous avez demandé à réinitialiser votre mot de passe sur NexRank.</p>
    ...
    """
    await send_email(to=to, subject="Réinitialisation de votre mot de passe NexRank", html_content=html)